  ...
  data() {
    return {
      videos: [
        ...
        {
          index: "2",
          title: "Pack acquisition and War",
          videoUrl: "https://www.youtube.com/embed/Mhx3C0yOcIU",
          texts: [
            "With your Soldier unlocked and your fighting spirit for war, you need a good warriors, don't you? So you need to buy a unit pack to go to war. ",
            "By purchasing the pack, you will be ready to go to war with troops.",
            "Watch the video to understand how to do each simple step.",
          ],
        },
        {
          index: "3",
          title: "Unlock Soldier and Recharge",
        ...
        },
        {
          index: "4",
          title: "Claim Rewards",
          videoUrl: "https://www.youtube.com/embed/jg60CBhX4hU",
          texts: [
